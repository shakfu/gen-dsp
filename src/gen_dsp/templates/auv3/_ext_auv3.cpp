// _ext_auv3.cpp - Gen~ wrapper implementation for AUv3 opcode
// This file includes genlib and the exported code, NO AUv3 headers
// Provides wrapper functions that can be called from the AUv3 bridge
...
// Genlib headers (must NOT be mixed with AUv3 headers)
#include "genlib.h"
...
#include "auv3_buffer.h"

namespace WRAPPER_NAMESPACE {

// Define buffer instances
#ifdef WRAPPER_BUFFER_NAME_0
    AUv3Buffer WRAPPER_BUFFER_NAME_0;
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    AUv3Buffer WRAPPER_BUFFER_NAME_1;
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    AUv3Buffer WRAPPER_BUFFER_NAME_2;
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    AUv3Buffer WRAPPER_BUFFER_NAME_3;
#endif
#ifdef WRAPPER_BUFFER_NAME_4
    AUv3Buffer WRAPPER_BUFFER_NAME_4;
#endif
#ifdef WRAPPER_BUFFER_NAME_5
    AUv3Buffer WRAPPER_BUFFER_NAME_5;
#endif
#ifdef WRAPPER_BUFFER_NAME_6
    AUv3Buffer WRAPPER_BUFFER_NAME_6;
#endif
#ifdef WRAPPER_BUFFER_NAME_7
    AUv3Buffer WRAPPER_BUFFER_NAME_7;
#endif
