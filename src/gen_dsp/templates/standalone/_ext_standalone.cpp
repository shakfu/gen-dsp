// _ext_standalone.cpp - Gen~ wrapper implementation for standalone
// This file includes genlib and the exported code, NO host API headers
// Provides wrapper functions that can be called from the main application

#include "gen_ext_common_standalone.h"
...
// Genlib headers (must NOT be mixed with host API headers)
#include "genlib.h"
...
// Defined here to match the declaration in _ext_standalone.h
typedef void GenState;

// Buffer support for gen~ (uses genlib's DataInterface)
#include "standalone_buffer.h"

namespace WRAPPER_NAMESPACE {

// Define buffer instances
#ifdef WRAPPER_BUFFER_NAME_0
    StandaloneBuffer WRAPPER_BUFFER_NAME_0;
#endif
#ifdef WRAPPER_BUFFER_NAME_1
    StandaloneBuffer WRAPPER_BUFFER_NAME_1;
#endif
#ifdef WRAPPER_BUFFER_NAME_2
    StandaloneBuffer WRAPPER_BUFFER_NAME_2;
#endif
#ifdef WRAPPER_BUFFER_NAME_3
    StandaloneBuffer WRAPPER_BUFFER_NAME_3;
#endif
#ifdef WRAPPER_BUFFER_NAME_4
    StandaloneBuffer WRAPPER_BUFFER_NAME_4;
#endif
#ifdef WRAPPER_BUFFER_NAME_5
    StandaloneBuffer WRAPPER_BUFFER_NAME_5;
#endif
#ifdef WRAPPER_BUFFER_NAME_6
    StandaloneBuffer WRAPPER_BUFFER_NAME_6;
#endif
#ifdef WRAPPER_BUFFER_NAME_7
    StandaloneBuffer WRAPPER_BUFFER_NAME_7;
#endif
